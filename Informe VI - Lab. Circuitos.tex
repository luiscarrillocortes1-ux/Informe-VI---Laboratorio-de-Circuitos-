...
\begin{figure}[htbp]
    \centering
\includegraphics[width=0.75\linewidth]{nodo a a tierra.JPG}
    \caption{Nodo A a tierra}
    \label{fig:montaje 4}
\end{figure}
\begin{figure}[htbp]
    \centering
\includegraphics[width=0.75\linewidth]{nodo b a tierra.JPG}
    \caption{Nodo B a tierra}
    \label{fig:montaje 4}
\end{figure}
\begin{figure}[htbp]
    \centering
\includegraphics[width=0.75\linewidth]{Nodo A y B superpuestos.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\linewidth]{puente reductor.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\linewidth]{nodo a-b Luis.JPG}
    \caption{Señal Nodo A-B}
    \label{fig:rectificador-montaje}
\end{figure}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\linewidth]{nodo c-d Luis.JPG}
    \caption{Señal Nodo C-D}
    \label{fig:rectificador-montaje}
\end{figure}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\linewidth]{5 sin nodo.jpg}
