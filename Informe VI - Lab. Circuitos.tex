...
En la práctica se prescindió del transformador planteado originalmente y se procedió a realizar las mediciones conectando de forma directa el generador de funciones al canal~1 del osciloscopio. La salida del generador se fijó con una onda cuadrada de \SI{5}{\volt} pico a pico y frecuencia de \SI{1}{\kilo\hertz}, utilizando el cable coaxial y el retorno a tierra del mismo instrumento para garantizar una referencia común. Sobre el protoboard únicamente se dispusieron la resistencia de \SI{1}{\kilo\ohm} y el condensador en serie, tomando con la sonda del osciloscopio el voltaje en el nodo del condensador para observar los transitorios de carga y descarga. La Figura~\ref{fig:montaje 4} muestra la simplicidad del arreglo empleado, mientras que las Figuras~\ref{fig:simulacion-rc-esquematico} y~\ref{fig:simulacion-rc-respuesta} provienen de la simulación utilizada para contrastar los resultados experimentales.
\begin{figure}[htbp]
    \centering
